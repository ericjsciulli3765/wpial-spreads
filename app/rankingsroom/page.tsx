...
const weeklyRankingsData: WeeklyRankingsData = {
  'Week 1': {
    '6A': [
      ...
      { rank: 3, team: 'Mt. Lebanon', record: '0-0', previousRank: '3' },
      { rank: 4, team: 'Seneca Valley', record: '0-0', previousRank: '4' },
      { rank: 5, team: 'Canon McMillan', record: '0-0', previousRank: '5' },
      { rank: 6, team: 'Hempfield', record: '0-0', previousRank: '6' },
      { rank: 7, team: 'Norwin', record: '0-0', previousRank: '7' },
    ],
    '5A': [
      { rank: 1, team: 'Peters Township', record: '0-0', previousRank: '1' },
      { rank: 2, team: 'Pine Richland', record: '0-0', previousRank: '2' },
      { rank: 3, team: 'Upper St. Clair', record: '0-0', previousRank: '3' },
      { rank: 4, team: 'Penn Trafford', record: '0-0', previousRank: '4' },
      { rank: 5, team: 'Woodland Hills', record: '0-0', previousRank: '5' },
      ...
      { rank: 10, team: 'Moon', record: '0-0', previousRank: '10' },
